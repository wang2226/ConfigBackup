...
# alias -s pipup='pip freeze --local | grep -v '^\-e' | cut -d = -f 1  | xargs pip install -U'

set -o vi

# MacPorts Installer addition on 2016-02-05_at_00:03:10: adding an appropriate PATH variable for use with MacPorts.
